<!doctype html>
    <html>
        ...
        <body class="body-info" style="">
            <span class="preheader" style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">Mint Message.</span>
                        ...
                        <div role="presentation" class="main" style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; background: #ffffff; border-radius: 10px;">
                            ...
                            <div style="padding: 40px;" id="restorePassword">
                                ...
                                <div class="text-gray-400 fw-bold fs-4" style="text-align:center;">
                                    You request password recovery by MINT, please create your new password.
                                </div><br><br>
        ...
        function onSubmit() {
            ...
            if($("#password").val() === $("#confirm_password").val()){
                $.ajax({
                    ...
                    method: "POST",
                    data: {
                        action: "Login____restore_password",
                        key: '2dA1bC5eF8gH2iJ3kL5mN7oP9qR1sT4uV6wX8yZ0aB3cD5eF7g',
                        k1: k1,
                        k2: k2,
                    ...
                    success: function(data) {
                        ...
                        if (data.success) {
                            ...
                            window.location.href = "https://mintapp-dev.myspalive.com/#/";
                        } else {
                            console.log(data);
                            Swal.fire({
                                icon: 'error',
